...
export const USER_RESULT_PER_PAGE = 2
export const BOOK_GENRE = ["COMEDY","THRILLER","SCIENCE","MYSTERY","FICTION","NON_FICTION"]
export const BOOK_RESULT_PER_PAGE = 3
export const ISSUE_TRANSACTION_TYPE = ["PENDING","ISSUED","RETURNED"]
export const ALL_ISSUE_RESULT_PER_PAGE = 2
export const SINGLE_USER_ISSUE_RESULT_PER_PAGE = 3